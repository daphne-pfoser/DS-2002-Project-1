# Code to creating the dim_date ( date dimensition) table: 
...
# Populate the date dimenstion table with data starting from January 1, 2003 and ending in Decemebr 31,2005
CALL PopulateDateDimension('2003-01-01', '2005-12-31');

# Making sure the above was coded correctly 
SELECT MIN(full_date) AS BeginDate
	, MAX(full_date) AS EndDate
FROM dim_date; 


## Authoring SQL Queries to demonstrate proper functionality
